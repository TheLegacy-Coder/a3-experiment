...
function renderSVG(color) {
    ...
    const singleSVGSelect = d3.select("#radial_1900");
    ...
    const radialContainer1900 = d3.select("#radial_1900")
        .append("svg")
            .attr("width", width + margin.left + margin.right)
            .attr("height", height + margin.top + margin.bottom)

    radialContainer1900.append("g")
...
document.getElementById("radial_1900_color").onchange = function () {
    renderSVG(document.getElementById("radial_1900_color").value);
};
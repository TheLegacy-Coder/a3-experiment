...
function renderSVG(color) {
    ...
    const singleSVGSelect = d3.select("#line_1900");
...
document.getElementById("line_1900_color").onchange = function () {
    renderSVG(document.getElementById("line_1900_color").value);
};
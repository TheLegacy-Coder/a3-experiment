...
function renderSVG(color) {
    ...
    const singleSVGSelect = d3.select("#bar_2020");
...
document.getElementById("bar_2020_color").onchange = function () {
    renderSVG(document.getElementById("bar_2020_color").value);
};